...
namespace NinjaTrader.NinjaScript.Indicators
{
    public class AIQ_SuperBandsEquivalent : Indicator
    {
        ...
        /// Used by NHTS strategy for confluence detection
        /// </summary>
        [Browsable(false)]
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private AIQ_SuperBandsEquivalent[] cacheAIQ_SuperBandsEquivalent;
		public AIQ_SuperBandsEquivalent AIQ_SuperBandsEquivalent(int halfLength_Main, double bandsDeviation_Main, int halfLength_Fast, double bandsDeviation_Fast, bool staticBands, bool optimizeMainDeviation, int maxOutOfBandPercent, double pctAbove, double pctBelow, bool enableMainBands, bool enableFastBands, bool enableTriangles, bool enableLines, Brush mainBandColor, Brush mainMiddleColor, Brush fastBandColor)
		{
			return AIQ_SuperBandsEquivalent(Input, halfLength_Main, bandsDeviation_Main, halfLength_Fast, bandsDeviation_Fast, staticBands, optimizeMainDeviation, maxOutOfBandPercent, pctAbove, pctBelow, enableMainBands, enableFastBands, enableTriangles, enableLines, mainBandColor, mainMiddleColor, fastBandColor);
		}

		public AIQ_SuperBandsEquivalent AIQ_SuperBandsEquivalent(ISeries<double> input, int halfLength_Main, double bandsDeviation_Main, int halfLength_Fast, double bandsDeviation_Fast, bool staticBands, bool optimizeMainDeviation, int maxOutOfBandPercent, double pctAbove, double pctBelow, bool enableMainBands, bool enableFastBands, bool enableTriangles, bool enableLines, Brush mainBandColor, Brush mainMiddleColor, Brush fastBandColor)
		{
			if (cacheAIQ_SuperBandsEquivalent != null)
				for (int idx = 0; idx < cacheAIQ_SuperBandsEquivalent.Length; idx++)
					if (cacheAIQ_SuperBandsEquivalent[idx] != null && cacheAIQ_SuperBandsEquivalent[idx].HalfLength_Main == halfLength_Main && cacheAIQ_SuperBandsEquivalent[idx].BandsDeviation_Main == bandsDeviation_Main && cacheAIQ_SuperBandsEquivalent[idx].HalfLength_Fast == halfLength_Fast && cacheAIQ_SuperBandsEquivalent[idx].BandsDeviation_Fast == bandsDeviation_Fast && cacheAIQ_SuperBandsEquivalent[idx].StaticBands == staticBands && cacheAIQ_SuperBandsEquivalent[idx].OptimizeMainDeviation == optimizeMainDeviation && cacheAIQ_SuperBandsEquivalent[idx].MaxOutOfBandPercent == maxOutOfBandPercent && cacheAIQ_SuperBandsEquivalent[idx].PctAbove == pctAbove && cacheAIQ_SuperBandsEquivalent[idx].PctBelow == pctBelow && cacheAIQ_SuperBandsEquivalent[idx].EnableMainBands == enableMainBands && cacheAIQ_SuperBandsEquivalent[idx].EnableFastBands == enableFastBands && cacheAIQ_SuperBandsEquivalent[idx].EnableTriangles == enableTriangles && cacheAIQ_SuperBandsEquivalent[idx].EnableLines == enableLines && cacheAIQ_SuperBandsEquivalent[idx].MainBandColor == mainBandColor && cacheAIQ_SuperBandsEquivalent[idx].MainMiddleColor == mainMiddleColor && cacheAIQ_SuperBandsEquivalent[idx].FastBandColor == fastBandColor && cacheAIQ_SuperBandsEquivalent[idx].EqualsInput(input))
						return cacheAIQ_SuperBandsEquivalent[idx];
			return CacheIndicator<AIQ_SuperBandsEquivalent>(new AIQ_SuperBandsEquivalent(){ HalfLength_Main = halfLength_Main, BandsDeviation_Main = bandsDeviation_Main, HalfLength_Fast = halfLength_Fast, BandsDeviation_Fast = bandsDeviation_Fast, StaticBands = staticBands, OptimizeMainDeviation = optimizeMainDeviation, MaxOutOfBandPercent = maxOutOfBandPercent, PctAbove = pctAbove, PctBelow = pctBelow, EnableMainBands = enableMainBands, EnableFastBands = enableFastBands, EnableTriangles = enableTriangles, EnableLines = enableLines, MainBandColor = mainBandColor, MainMiddleColor = mainMiddleColor, FastBandColor = fastBandColor }, input, ref cacheAIQ_SuperBandsEquivalent);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.AIQ_SuperBandsEquivalent AIQ_SuperBandsEquivalent(int halfLength_Main, double bandsDeviation_Main, int halfLength_Fast, double bandsDeviation_Fast, bool staticBands, bool optimizeMainDeviation, int maxOutOfBandPercent, double pctAbove, double pctBelow, bool enableMainBands, bool enableFastBands, bool enableTriangles, bool enableLines, Brush mainBandColor, Brush mainMiddleColor, Brush fastBandColor)
		{
			return indicator.AIQ_SuperBandsEquivalent(Input, halfLength_Main, bandsDeviation_Main, halfLength_Fast, bandsDeviation_Fast, staticBands, optimizeMainDeviation, maxOutOfBandPercent, pctAbove, pctBelow, enableMainBands, enableFastBands, enableTriangles, enableLines, mainBandColor, mainMiddleColor, fastBandColor);
		}
